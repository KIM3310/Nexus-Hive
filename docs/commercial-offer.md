# Commercial Offer - With live LLM inference via Ollama:
...
| Entry price assumption | $5k-$12k discovery + demo |
...
- Lead with the buyer's workflow: "For Data platform teams, BI owners, and operations leaders who need self-service questions without uncontrolled SQL, the hard part is often moving from proof to operating handoff without creating new risk."
- Use the proof hook: "I can show the first proof artifact (make verify passes), then map it to one workflow you already own."
- Use the metric hook: "The first scorecard can focus on Policy pass/reject clarity, not a vague AI transformation claim."
