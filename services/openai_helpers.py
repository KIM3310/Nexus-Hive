...
# main.py re-exports call_openai_moderation / call_openai_architecture_demo_summary
...
call_openai_architecture_demo_summary = _call_openai_architecture_demo_summary
